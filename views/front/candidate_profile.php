...
<script type="text/javascript" src="1https://talentscrew.com/includes-nct/javascript-nct/jquery.validate.min.js"></script>
<script type="text/javascript" src="1https://talentscrew.com/includes-nct/javascript-nct/toastr.js"></script>
<script type="text/javascript" src="1https://talentscrew.com/includes-nct/javascript-nct/paging/jquery.twbsPagination.min.js"></script>
...
<!--                                   // <?php //print_r($candidateDetail)?>-->
    ...
    <div class="container">
      ...
      <div class="row" style="margin-bottom: -4%;margin-top: 1%;">
        <div class="col-md-6 col-lg-4">
          <a href="<?php echo base_url('Home/candidateJobStatus');?>" title="View Your Job Applications" style="text-decoration: none;  text-align: center;">
          <div class="widget-small primary coloured-icon" style="width: 100%;height:10%;"><i class="icon fa fa-file-text-o fa-3x" aria-hidden="true"></i>
            <div class="info">
         ...
         <div class="col-md-6 col-lg-4">
          <a href="<?php echo base_url('Home/');?>" target="_blank" title="Search Jobs" style="text-decoration: none;  text-align: center;">
          <div class="widget-small info coloured-icon" style="width: 100%;height:10%;"><i class=" icon fa fa-bell fa-3x" aria-hidden="true"></i>
            <div class="info">
              <h4 style="color:#17a2b8;">Live Search Jobs</h4>
        ...
        <div class="col-md-6 col-lg-4">
          <a href="<?php echo base_url('Home/jobs');?>" target="_blank" title="Jobs For Me/Jobs Search" style="text-decoration: none;  text-align: center;">
          <div class="widget-small warning coloured-icon" style="width: 100%;height:10%;"><i class=" icon fa fa-black-tie fa-3x" aria-hidden="true"></i>
            <div class="info">
              <h4 style="color:#28a745;;">Jobs For Me/Jobs Search</h4>
              <p style="text-align: center;"><b>100+</b></p>
            </div>
          </div>
        </a>
	...
	<div class="jp_cp_profile_main_wrapper" style="margin-top:-100px">
		<div class="container">
			<div class="row">
                 
		<div class="col-md-3 col-sm-12 col-xs-12">
          <center> <div id="main-card">
          <div class="cover-photo"></div>
          <div class="photo">
             <?php if($candidateDetail[0]->image==''){?>
             <img src="https://talentscrew.com/themes-nct/images/user_img.png"  alt="user" title="user">
             <?php }else{?>
            <img src="<?php echo base_url('assets/upload/');?><?=$candidateDetail[0]->image?>"  alt="user" title="user">
             <?php }?>

		
          </div>
          <div class="content">
              <h3 class="name" style="margin-top: -48px;"><?=$candidateDetail[0]->username?></h3>
              	<p style="text-align:center;"><?=$candidateDetail[0]->designation?></p>
              <h4 class="fullstack"></h4>
             <div class="exp" style="display: flex;align-items: center;">
                <span><i class="fa fa fa-map-marker"></i></span>
                <span style="margin-left:10px;"><?=$candidateDetail[0]->city?> </span>
            </div>
  ...
  <div class="col-md-6 col-sm-12 main-card">
    <center><div style="padding:20px;border: 1px solid #ccc;box-shadow: 0 0 5px #999;border-radius:15px;">
        <h2 style="text-align:center;font-weight:bold;">PERSONAL DETAILS</h2><br>
                             <table>
                                <tbody style="margin-right:10px; text-align:center;font-weight:bold;">
                                    <tr>
                                        <td style="margin-left:10px;">Full Name</td>
                                        <td><?=$candidateDetail[0]->username?></td>
                                    </tr>
                                    <tr>
                                        <td>Experience</td>
                                        <td><?=$candidateDetail[0]->exp?></td>
                                    </tr>
                                   
                                    <tr>
                                        <td>Address</td>
                                        <td><?=$candidateDetail[0]->address?></td>
                                    </tr>

                                    <tr>
                                        <td >Phone</td>
                                        <td ><?=$candidateDetail[0]->mobileNo?></td>
                                    </tr>
                                    <tr>
                                        <td>Email</td>
                                        <td><?=$candidateDetail[0]->email?></td>
                                    </tr>
                                </tbody>
                                </table>
      ...
      <h6 class="tile-title text-center" style="padding:11px;border-radius:5px 5px 0px 0px;  background: linear-gradient(45deg, #30354d,#05ccda, #2980b9);color:#fff;font-size: 25px;">Profile Completed</h6>
        <!--  <div class="embed-responsive embed-responsive-16by9">
           ...
           <section id="circleBar" style="height:287px!important;">
            <div class="round" data-value=".90" data-size="198" data-thickness="10">
              <strong></strong>
            </div>
             <a class="view-more" href="<?php echo base_url('home/candidateEdit');?>/<?=$candidateDetail[0]->id ?>" style="bottom: 18px;text-decoration: none;position: relative;display: flex;justify-content: center;width: 100%;top: -13%;font-family:sans-serif!important;background: #30354d;padding:15px;border-radius: 0px 0px 10px 10px;color:#fff!important;text-transform:capitalize;">Edit Profile</a>
          </section>   
    </div>
</div>
</div>
