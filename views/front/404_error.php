...
<!-- Mirrored from www.webstrot.com/html/jobpro/job_light/404_error.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Nov 2019 10:43:19 GMT -->
                ...
                <div class="row">
                            ...
                            <div class="mainmenu">
                                ...
                                <ul class="float_left">
                                    <li class="has-mega gc_main_navigation"><a href="#" class="gc_main_navigation">  Home&nbsp;<i class="fa fa-angle-down"></i></a>
                                        <!-- mega menu start -->
                                        <ul>
                                            <li class="parent"><a href="index.php">Home1</a></li>
                                            <li class="parent"><a href="index_II.php">Home2</a></li>
                                            <li class="parent"><a href="index_map.php">Home3</a></li>
                                            <li class="parent"><a href="index_iv.php">Home4</a></li>
                                            <li class="parent"><a href="index_v.php">Home5</a></li>
                                            <li class="parent"><a href="index_vi.php">Home6</a></li>
                                        </ul>
                                    </li>
									...
									<li class="has-mega gc_main_navigation"><a href="#" class="gc_main_navigation">  Pages&nbsp;<i class="fa fa-angle-down"></i></a>
                                        ...
                                        <ul>
                                            ...
                                            <li class="parent"><a href="404_error.php">404</a></li>
                                            <li class="parent"><a href="add_postin.php">Add-Posting</a></li>
											 <li class="parent"><a href="login.php">Login</a></li>
                                            <li class="parent"><a href="register.php">Register</a></li>
                                            <li class="parent"><a href="pricing.php">Pricing</a></li>
                                        </ul>
                                    </li>
                    ...
                    <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12 hidden-sm hidden-xs">
                        <div class="jp_navi_right_btn_wrapper">
                            <ul>
                                <li><a href="add_postin.php"><i class="fa fa-plus-circle"></i>&nbsp; Post a job</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
			 <div class="col-md-10 col-md-offset-1 col-sm-12 col-xs-12 text-center">
                    <div class="error_page_cntnt">
                        ...
                        <p>This is Photoshop's version of Lorem Ipsum. Proin gravida nibh vel velit auctor aliquet. A Aenean sollicitudin, lorem quis bibend Aenean sollicitudin, lorem . <a href="index.php">Home Page</a></p>
