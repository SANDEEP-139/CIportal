                    ...
                    <div class="content_wrapper">
                        ...
                        <div class="table_body text-left">
                            <table id="example" class="table table-condensed responsive table_custom" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    <?php $a = 1; foreach($categorys as $category): ?>
                                    <tr>
                                        <td>
                                            <?php echo $a; ?>
                                        </td>
                                        ...
                                        <td class="action-buttons">
                                            <button type="button" id="category" data-id="<?php echo $category['cat_id']; ?>" name="submit" class="catbutton">
            ...
            <form enctype="multipart/form-data" id="catmodal" method="post" name="catmodal" role="form" accept-charset="utf-8">
                <div class="modal-body">
                    <div class="form-group clearfix">
                        <label class="col-md-3" for="inputMaxLength">Ad Category Name</label>
                        <div class="col-md-9">
                            <input class="form-control" id="name" name="name" placeholder="Ad Category name" required type="text" value=''>
                        </div>
                    </div>
                    <div class="form-group clearfix">
...
<script>
    $("#addcategory").on("click", function(event) {
        ...
        $.ajax({
            url: "<?php echo base_url();?>crud/doAddAdCategoryData",
            type: "POST",
            dataType: 'json',
            data: {
                'cat_id': $('#catid').val(),
...
<script type="text/javascript">
    $(document).ready(function() {
        $(".catbutton").click(function(e) {
            ...
            $('#categoryform').modal('show');
            $.ajax({
                url: '<?php echo base_url();?>crud/adCategoryById?id=' + iid,
                method: 'GET',
                data: '',
                dataType: 'json',
