        ...
        <div class="modal-content">
            ...
            <form role="form" action="" id="brandmodal" method="" enctype="multipart/form-data" accept-charset="utf-8">
                ...
                <div class="form-group clearfix">
                      <label for="inputMaxLength" class="col-md-3">City Select</label>
                     <div class="col-md-9">
                            <select id="city_id" name="city_id" class="form-control" style="width: 100%" required> 
                              <option value="">Select City Here..</option>               
                              <?php print_r($citys); foreach($citys as $city){?>                    
    ...
    $(document).ready(function() {
        $(".brandbutton").click(function(e) {
            ...
            $.ajax({
                ...
                $('#brandmodal').find('[name="city_id"]').val(response.brandvalue.city_id).end();
